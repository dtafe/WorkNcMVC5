...
namespace WorkNCInfoService.Domain
{
    ...
    {
        static readonly string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings[Constant.WORKNC_CONNECTIONSTRING] != null ? System.Configuration.ConfigurationManager.ConnectionStrings[Constant.WORKNC_CONNECTIONSTRING].ConnectionString : null;
