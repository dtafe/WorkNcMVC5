...
{
    public class WorkNCPortalModuleBase : System.Web.UI.Page
    {
        protected string GetCompanyPath()
        {
            DropDownList cboOfficeCd = new DropDownList();
            cboOfficeCd = (DropDownList)Master.FindControl("cboCompanyName");
            return string.Format(Constant.PATH_COMPANY, cboOfficeCd.SelectedValue, cboOfficeCd.SelectedItem.Text);
        }
